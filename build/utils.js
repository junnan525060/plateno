...
/** @method assertsPath  生成静态资源的路径(判断开发环境和生产环境,
 *            为config文件中index.js文件中定义assetsSubDirectory)
...
exports.assetsPath = function (_path) {
  ...
  //nodeJs path提供用于处理文件路径的工具;
  // path.posix提供对路径方法的POSIX(可移植性操作系统接口)特定实现的访问(可跨平台);
  // path.posix.join与path.join一样，不过总是以 posix 兼容的方式交互
  return path.posix.join(assetsSubDirectory, _path)
}

/**@method cssLoaders  生成处理css的loaders配置,使用css-loader和postcssLoader,
 *          通过options.usePostCSS属性来判断是否使用postcssLoader中压缩等方法
 * @param  {Object} option = {sourceMap: true,// 是否开启
 *                            sourceMapextract: true // 是否提取css
 *                           }生成配置
...
exports.cssLoaders = function (options) {
  ...
  function generateLoaders(loader, loaderOptions) {
    ...
    if (options.extract) { //的生产环境中默认是true
